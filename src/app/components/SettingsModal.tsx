...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
  ...
  const navigateToTerms = () => {
    router.push('/settings?tab=terms');
    onClose();
  };
      ...
      >
        <div className="flex justify-between items-center h-[60px] px-4 bg-med-green">
          <div className="flex items-center">
            <button 
              onClick={handleClose}
              className="text-white hover:text-gray-200 mr-3 cursor-pointer transition-colors duration-200"
            >
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="mb-6">
            <h3 className="text-lg font-medium mb-4 text-black dark:text-white">Settings</h3>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white dark:bg-zinc-700 rounded-lg shadow-sm">
                ...
                <button 
                  ...
                  className="mt-2 text-med-green hover:text-dark-green dark:hover:text-light-green font-medium cursor-pointer transition-colors duration-200"
                >View</button>
              </div>
